                ...
                <form class="form-inline">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1"><img src="Pokeball.png" width="30" height="50" alt="Pokeball"></img></span>
                        </div>
                        <input type="text" class="form-control" placeholder="Search Pokemon" aria-label="Username" aria-describedby="basic-addon1" />
                    </div>
                </form>
            </nav>
